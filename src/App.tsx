...
import FileManagement from "./components/FileManagement"; // Correctly importing as a default
                  ...
                  <div className="flex-1 flex flex-col">
                    ...
                    <main className="flex-1 overflow-auto">
                      <Routes>
                        ...
                        <Route path="/files" element={<FileManagement />} /> {/* Using the imported component */}
